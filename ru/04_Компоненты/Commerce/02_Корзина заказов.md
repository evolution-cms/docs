...
**instance**  - функционал для отображения: корзина, избранное, сравнение.
Значения: products, wishlist, comparison.

**theme** - папка темы для шаблонов. 
Пример:
```
&theme=`myshop`
```
Шаблоны из папки `assets/plugins/commerce/templates/front/myshop/`
